...
export const coreLoop = [
  ...
  { step: 3, title: 'Points 兑换', desc: '引导用户优先兑换课程、MBC Tournaments 和交流名额。' },
  { step: 4, title: '线下体验', desc: '活动现场完成试穿、社交、内容采集和复购邀约。' },
  { step: 5, title: '内容扩散', desc: '晒单、球场打卡和活动照片回流社区。' },
];

export const modules = [
  { icon: '', title: 'Home', desc: '等级、Credits、Points 余额、待完成任务。' },
...
export const rules = [
  '等级靠 Credits（成长值），Points（积分）靠行为和消费。',
  'Credits 不可消费，记录品牌贡献深度；Points 可消费，兑换体验服务。',
  'Points 优先兑换体验服务，不只是抵扣商品。',
  'MBC Tournaments 名额保持稀缺，形成报名和升级动力。',
  'MBC Tournaments 和课程是高尔夫服装 CRM 的差异化核心。',
  '高等级用户获得身份权益，而不是单纯更大折扣。',
  '导购从销售角色升级为会员顾问。',
  'L1-L3 每年自然年 Credits 清零，等级回到 L1，Points 余额保留。',
  'L4 年费制需每年续费，或达成 Credits 目标免年费。',
  'L5 需通过年度消费活跃度评估。',
  '等级对应权益，保住等级才能持续享受专属服务。',
];

export const metrics = [
  { label: '会员月活跃率', target: '> 40%', desc: '参考理想汽车 App 车主活跃度' },
  { label: 'Points 兑换率', target: '> 60%', desc: '避免 Points 沉淀成为数字负担' },
  { label: 'UGC 月均产出', target: '> 500 条', desc: '体现社区活跃度' },
  { label: '邀请裂变系数', target: '> 0.3', desc: '每位老会员平均带来 0.3 个新注册' },
];

export const roadmap = [
  { phase: 'MVP', time: '1-2 个月', focus: '基础等级体系 + 消费返 Points + 签到打卡 + 基础活动报名' },
  { phase: '扩展', time: '3-4 个月', focus: 'Points 兑换系统、成就徽章、邀请裂变、UGC 内容激励' },
  { phase: '成熟', time: '5-6 个月', focus: 'MBC 付费会员上线、Condor 邀请制、排行榜、球场打卡联动计分卡' },
  { phase: '迭代', time: '持续', focus: '数据优化 Points 比例、增加跨界联名活动、海外体验' },
];
