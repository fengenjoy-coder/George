...
export const coreLoop = [
  ...
  { step: 3, title: 'Coins兑换', desc: '引导用户优先兑换课程、MBC Tournaments 和交流名额。' },
...
export const metrics = [
  ...
  { label: 'Coins兑换率', target: '> 60%', desc: '避免Coins沉淀成为数字负担' },
...
export const roadmap = [
  ...
  { phase: '迭代', time: '持续', focus: '数据优化Coins比例、增加跨界联名活动、海外体验' },
];
